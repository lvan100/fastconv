...
func TestEncode_String(t *testing.T) {
	encodeSuccess(t, "abc", GetBuffer().String("", "abc"))
	encodeSuccess(t, Ptr("abc"), GetBuffer().String("", "abc"))
}
...
//	success[string, int](t, "3", 3)
//	success[string, int8](t, "3", 3)
//	success[string, int16](t, "3", 3)
//	success[string, int32](t, "3", 3)
//	success[string, int64](t, "3", 3)
//	success[string, uint](t, "3", 3)
//	success[string, uint8](t, "3", 3)
//	success[string, uint16](t, "3", 3)
//	success[string, uint32](t, "3", 3)
//	success[string, uint64](t, "3", 3)
//	success[string, float32](t, "3", 3)
//	success[string, float64](t, "3", 3)
//	success[string, string](t, "3", "3")
//	success[string, interface{}](t, "3", "3")
//
